...
Parece que esta pandemia está siendo gestionada de forma muy distinta por cada país y los resultados de esta gestión estan siendo también muy distintos. Entonces ¿de qué depende el que la respuesta sea mejor en un lado que en otro? Supongo que de varios factores, pero...¿cuáles de ellos son más determinantes?  
...
Podemos visualizar la tabla que hemos armado y explorar los datos recopilados para cada país (con el fantástico paquete *DT* podemos mostrar el contenido de tablas de forma interactiva permitiendo buscar, filtrar y ordenar columnas convenientemente para mostrar los ranquines de los países según cada variable).
...
Ahora fijémonos en la percepción de la corrupción:
...
Y la percepción de la corrupción en Europa:
...
Ahora probemos de visualizar un correlograma para relacionar los indicadores que tenemos:
...
Quizás el nivel de corrupción influye en el número de muertes producidas. Quizás también las libertades civiles, el nivel de cultura política o el que el gobierno funcione puede afectar algo a como se gestiona una pandemia?
