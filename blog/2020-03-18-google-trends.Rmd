...
Busquem quina és la tendència d'una sèrie de paraules ("coronavirus", "business", "work", "economy", "poverty"), dins d'aquesta categoria.

```{r topcatsports2, echo=FALSE}
industry <- gtrends(c("coronavirus", "business", "work", "economy", "poverty"),category = 12, time = "today 1-m" )
plot(industry)
```
