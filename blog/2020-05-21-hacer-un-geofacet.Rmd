...
El paquet inclou malles per representar les diferents regions del món en quadrícules on puc posar-hi les dades que m'interessin. Aquestes són les grids d'Espanya:
...
ggplot(cercaInterestByRegion, aes(keyword, hits, fill = keyword)) +
  ...
  coord_flip() +
  labs(title = "Volums de cerques de paraules per CC.AA.",
